...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=['en','zh','en_int','zh_int','en_fact','zh_fact', 'en_refine']
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--url', type=str, default='https://api.groq.com/openai/v1/chat/completions',
        help='url of chatgpt'
    )
    parser.add_argument(
    ...
    elif 'groq' in modelname:
        model = GroqAPIModel(api_key = args.api_key, url = args.url)
